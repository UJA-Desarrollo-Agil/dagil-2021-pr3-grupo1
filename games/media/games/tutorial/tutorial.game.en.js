...
undum.game.situations = {
    ...
    /*Elección armas de villanos*/
    eleccion_villanos: new undum.SimpleSituation(
        "<p>.</p>",
        {
            heading: "Elección de armas",
        }
    ),
    ...
    /*Elección armas montaña*/
    eleccion_montana: new undum.SimpleSituation(
        "<p>.</p>",
        {
            heading: "Elección de armas",
        }
